        ...
        the_post(); ?>
							...
							<div id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> >
								...
								<div class="article-header">
									...
									<p class="meta"><?php echo 'Posted' ?> <time datetime="<?php echo the_time('Y-m-j'); ?>" pubdate><?php the_time('F jS, Y'); ?></time> <?php echo 'by'; ?> <?php the_author_posts_link(); ?> <span class="amp">&</span> <?php echo "filed under"; ?> <?php the_category(', '); ?>.</p>
